...
If you believe you have found a security issue in PureYAML, please report it
...
PureYAML is pre-1.0 and under active development. Security fixes are applied to
the `main` branch. Until a stable release exists, only the latest `main` is
supported.

## Scope

PureYAML generates static sites. The generated output is plain HTML, CSS, and
