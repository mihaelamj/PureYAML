...
Concurrency posture for PureYAML and PureYAML: immutability first, sparse actors, escape hatches always justified, grounded in the Swift Evolution proposals.
