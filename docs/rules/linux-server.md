...
Operational rules for PureYAML code that runs on Linux in production: HTTP client, logging, database, crypto, signals, resources, POSIX interop, file I/O, and Docker CI.
...
public final class PureYAMLloader: @unchecked Sendable {
