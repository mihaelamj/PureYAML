...
SwiftUI view rules for the planned PureYAML native editor: purely presentational, performant, accessible, reusable. Views observe ViewModels but contain ZERO business logic.
